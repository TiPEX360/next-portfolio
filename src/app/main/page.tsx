...
export default function Home() {
    return (
                <main className="px-5 flex-col max-w-4xl mx-auto">
                    <Link href="/archviz">Click me!</Link>
                    <OnScroll>
                    ...
                    <div style={{ textAlign: "center", width: "100%", padding: 'auto' }}>
                        {/* <Gallery width="100%">
              <GalleryImage >
                  <img onClick={() => smoothNavigate("/article/pancakes/", navigate)} src={cg6} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/miniature", navigate)} src={cg1} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/mountains", navigate)} src={cg2} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/weightless", navigate)} src={cg4} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/cube", navigate)} src={cg3} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/house", navigate)} src={exterior} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/house", navigate)} src={interior1} />
              </GalleryImage>
              <GalleryImage>
                  <img onClick={() => smoothNavigate("/article/house", navigate)} src={interior2} />
              </GalleryImage>
          </Gallery> */}
                        {/* <div onClick={() => smoothNavigate("/article/house", navigate)} className="button" style={{padding: 10}}>archviz gallery</div> */}
                    </div>
