...
import { basePath } from '../utils/url-helpers'

export default function Page() {
    return (
        <>
            <Intro />
            <div className="invisible overflow-hidden w-0 h-0">
                <p>
                ...
                <div>
                    <a href="/view/weightless">weightless</a>
                    <a href="/view/miniature">miniature</a>
                    <a href="/view/cube">cube</a>
                    <a href="/view/mountains">mountains</a>
                    <a href="/archviz">archviz</a>
                    <a href="/archviz">archviz</a>
                    <a href="/archviz">archviz</a>
                    <a href="/archviz">archviz</a>
                </div>
                <a href="/archviz">Archviz Gallery</a>
